...
const{createEpisodiesRules,validate}=require('../../validators/episode.validator')
...
router.put('/:id',checkToken,createEpisodiesRules,validate,episodeController.updateEpisodies);
